				...
				<div class="row">
					<div class="col-xl-3 col-md-6">
						<div class="card bg-secondary text-white mb-4">
							...
							<div class="card-footer d-flex align-items-center justify-content-between">
								<a class="small text-white stretched-link" href="horror_board"></a>
					...
					<div class="col-xl-3 col-md-6">
						<div class="card bg-secondary text-white mb-4">
							...
							<div class="card-footer d-flex align-items-center justify-content-between">
								<a class="small text-white stretched-link" href="horror_review"></a>
								<div class="small text-white">
									<i class="fas fa-angle-right"></i>
								</div>
							</div>
					...
					<div class="col-xl-3 col-md-6">
						<div class="card bg-secondary text-white mb-4">
							...
							<div class="card-footer d-flex align-items-center justify-content-between">
								<a class="small text-white stretched-link" href="horror_recom"></a>
								<div class="small text-white">
									<i class="fas fa-angle-right"></i>
								</div>
							</div>
					...
					<div class="col-xl-3 col-md-6">
						<div class="card bg-secondary text-white mb-4">
							...
							<div class="card-footer d-flex align-items-center justify-content-between">
								<a class="small text-white stretched-link" href="horror_info"></a>
								<div class="small text-white">
									<i class="fas fa-angle-right"></i>
								</div>
							</div>
							...
							<table class="board-table">
								...
								<tbody>
									<c:forEach var="vo" items="${list.content }">
										<tr>
											<td>${vo.num}</td>
											<td><a href="horror_contents?num=${vo.num }&page=${nowPage-1}">${vo.title}</a></td>
											<td>${vo.writer}</td>
