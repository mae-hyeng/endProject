			...
			<main class="min-width">
				...
				<div class="row">
					<div class="row-col-xl-1">
						...
						<input style="float: right" type="button" class="list-btn" value="목록" onclick="location.href='review_all?page='+'${param.page}'+'&keyword='+'${param.keyword }'">
				...
				function modi() {
					if('${one.writer}' != '${sessionScope.username}') {
						...
						location.href='info_modify?num=${one.num}&page=${param.page}';
					}
				}
				</script>
